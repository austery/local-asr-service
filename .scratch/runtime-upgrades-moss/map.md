...
- The documentation branch `codex/runtime-upgrades-moss-roadmap` includes remote main through `2ff1a34db7d6999714b6df64a313c56e484bc171`. Work only in `/Users/leipeng/Documents/Projects/local-asr-service-worktrees/runtime-roadmap` or another isolated worktree; leave the running original main checkout and its environment untouched. The measured baseline and runtime comparisons are captured; human quality acceptance remains open.
...
- [MLX runtime comparison](evidence/2026-09-07-runtime-validation.md): eight identical transcription texts, preserved tested contracts, three remaining speaker intervals requiring review.
- [MOSS upstream probe](evidence/2026-09-07-moss-probe.md): the current 60-minute candidate stops at 36:19; No-Go recommended for this pairing, awaiting Lei's decision.
- [FunASR candidate](evidence/2026-09-07-funasr-preflight.md): clean install and 308 existing tests pass; all real requests succeed, but changed text and repeated cost increases leave quality acceptance open.
