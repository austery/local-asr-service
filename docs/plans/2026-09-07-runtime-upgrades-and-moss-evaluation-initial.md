> Archived initial roadmap from commit `55909f1`. The text below preserves the original planning context, including its historical status. For current delivery and next actions, use the [maintained roadmap](2026-09-07-runtime-upgrades-and-moss-evaluation.md).
